...
export default function CommunitySection() {
  return (
    <section className="py-28 bg-[#09090a] relative border-t border-stone-900">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          {/* Card 1: WhatsApp Members Concierge */}
          <div className="p-8 sm:p-12 bg-stone-950 border border-stone-800 hover:border-[#c5a880]/60 transition-all duration-300 flex flex-col justify-between">
            ...
            <div className="pt-8">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-full py-3.5 px-6 bg-stone-900 hover:bg-[#c5a880] text-stone-200 hover:text-[#09090a] border border-stone-700 hover:border-[#c5a880] font-medium text-xs tracking-[0.2em] uppercase transition-all duration-300 flex items-center justify-center gap-2.5"
              >
