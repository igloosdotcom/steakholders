...
export default function LocationVisit({ onOpenReserve }: LocationVisitProps) {
  ...
  return (
    <section id="visit" className="py-28 bg-[#0c0c0e] relative border-t border-stone-900">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="max-w-4xl mx-auto bg-stone-950 border border-stone-800 p-8 sm:p-12 shadow-2xl space-y-8">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-6 border-b border-stone-800/80 gap-4">
            <div>
              ...
              <h3 className="text-2xl sm:text-3xl font-serif text-[#f5f2eb]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-xs text-stone-300 font-light bg-stone-900/50 p-4 border border-stone-850">
                <div>
                  <div className="text-stone-500 uppercase tracking-widest text-[10px]">Collection Address</div>
                  <div className="text-stone-200 mt-0.5 font-medium">
              ...
              <div className="space-y-2.5">
                <button
                  ...
                  className="w-full py-3.5 bg-[#c5a880] hover:bg-[#d6bc96] text-[#09090a] font-medium text-xs uppercase tracking-[0.2em] transition-colors flex items-center justify-center gap-2 shadow-lg"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-full py-2 text-[11px] uppercase tracking-wider text-stone-400 hover:text-stone-200 transition-colors flex items-center justify-center gap-1.5"
                >
            ...
            <div className="space-y-6 border-t md:border-t-0 md:border-l md:pl-8 lg:pl-12 border-stone-800/80 pt-6 md:pt-0">
              <div className="space-y-1">
              ...
              <div className="space-y-4 text-xs text-stone-300 font-light bg-stone-900/50 p-4 border border-stone-850">
                ...
                <div className="pt-2 border-t border-stone-800/80">
                  ...
                  <div className="text-stone-200 mt-0.5">{BRAND_INFO.email}</div>
                </div>
              </div>

              <div className="space-y-2.5">
                <div className="p-2.5 bg-stone-900/60 border border-stone-800 flex items-center justify-between text-xs">
                  <span className="font-mono text-stone-300 truncate">{BRAND_INFO.email}</span>
                  <button
                    onClick={handleCopyEmail}
                    className="px-2.5 py-1 text-[11px] uppercase tracking-wider text-[#c5a880] hover:text-white transition-colors flex items-center gap-1.5 shrink-0"
                  >
                ...
                <a
                  ...
                  className="w-full py-3.5 bg-transparent hover:bg-stone-200 text-stone-200 hover:text-[#09090a] border border-stone-700 hover:border-stone-200 font-medium text-xs uppercase tracking-[0.2em] transition-all duration-300 flex items-center justify-center gap-2"
                >
