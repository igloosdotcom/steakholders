...
export default function StorySection() {
  return (
    <section id="story" className="py-16 sm:py-24 bg-[#0c0c0e] relative border-t border-stone-900">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-5">
            <div className="relative border border-stone-800 bg-stone-950 p-2 shadow-2xl">
              ...
              <div className="pt-2.5 pb-1 px-1 flex items-center justify-between text-[10px] sm:text-[11px] text-stone-500 uppercase tracking-widest font-mono">
                <span>Figure 02. The Prep Station</span>
                <span>Est. London · Birmingham</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-6 sm:space-y-8">
            ...
            <div className="space-y-3 sm:space-y-4 text-stone-400 font-light text-xs sm:text-sm leading-relaxed border-t border-stone-800/80 pt-4 sm:pt-6">
              <p>
            ...
            {/* Three Refined Editorial Pillars */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 pt-4 sm:pt-6 border-t border-stone-800/80">
